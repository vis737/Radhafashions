    ...
    <div className="space-y-6 text-left font-sans select-none">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-gray-50 dark:border-gray-800 pb-4">
        ...
        <div className="flex items-center gap-2">
          {/* Timeframe selector */}
          <div className="flex bg-gray-50 dark:bg-gray-950 p-1 rounded-xl border border-gray-200/50">
            {(['daily', 'weekly', 'monthly', 'yearly'] as const).map((t) => (
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-[10px] uppercase font-bold tracking-wider transition cursor-pointer ${
                  timeframe === t
                    ? 'bg-white dark:bg-gray-800 text-pink-500 shadow-sm border border-gray-200'
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-3xl p-6 shadow-sm lg:col-span-2 space-y-4">
          <h4 className="font-display font-bold text-xs uppercase tracking-wider text-gray-900 dark:text-gray-50 flex items-center gap-1.5">
            <Calendar className="w-4 h-4 text-[#D4648A]" /> Revenue Growth Chart (Monthly)
          </h4>
          
          <div className="h-44 w-full flex items-end">
            <svg viewBox="0 0 400 120" className="w-full h-full text-indigo-500">
              <rect x="20" y="80" width="22" height="40" rx="3" className="fill-[#D4648A]/80 hover:fill-[#D4648A] transition duration-300" />
              <rect x="60" y="70" width="22" height="50" rx="3" className="fill-[#D4648A]/80 hover:fill-[#D4648A] transition" />
              <rect x="100" y="50" width="22" height="70" rx="3" className="fill-[#D4648A]/80 hover:fill-[#D4648A] transition" />
              <rect x="140" y="60" width="22" height="60" rx="3" className="fill-[#D4648A]/80 hover:fill-[#D4648A] transition" />
              <rect x="180" y="40" width="22" height="80" rx="3" className="fill-[#D4648A]/80 hover:fill-[#D4648A] transition" />
              <rect x="220" y="30" width="22" height="90" rx="3" className="fill-[#D4648A]/80 hover:fill-[#D4648A] transition" />
              <rect x="260" y="25" width="22" height="95" rx="3" className="fill-[#D4648A]/80 hover:fill-[#D4648A] transition" />
              <rect x="300" y="15" width="22" height="105" rx="3" className="fill-[#D4648A]/80 hover:fill-[#D4648A] transition" />
              <rect x="340" y="10" width="22" height="110" rx="3" className="fill-[#D4648A]/80 hover:fill-[#D4648A] transition" />
            </svg>
          </div>
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-3xl p-6 shadow-sm space-y-4 text-xs">
          ...
          <div className="space-y-4 pt-2">
            <div className="flex justify-between items-center">
              ...
              <span className="font-bold text-gray-950 dark:text-white">{metrics.newCustomers}%</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-500">Returning Customers</span>
              <span className="font-bold text-gray-950 dark:text-white">{metrics.returningCustomers}%</span>
            </div>
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-3xl p-6 shadow-sm space-y-3">
          ...
          <div className="space-y-2.5">
            {topProducts.map((p, idx) => (
              <div key={p.id} className="flex items-center justify-between text-xs border-b border-gray-50 dark:border-gray-800 pb-2 last:border-0 last:pb-0">
                <div className="flex items-center gap-2 text-left">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-white leading-none">{p.name}</p>
