        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-slate-500 mt-1">Manage MERIS memberships, points, and tiers.</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <motion.div whileHover={{ y: -2 }} className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
                ...
                <motion.div whileHover={{ y: -2 }} className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
                    <div className="flex justify-between items-start">
                        <div>
                            <p className="text-sm font-medium text-slate-500">Platinum Members</p>
                            <h3 className="text-2xl font-bold text-slate-900 mt-1">{stats.platinum}</h3>
                        </div>
                ...
                <motion.div whileHover={{ y: -2 }} className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
                    <div className="flex justify-between items-start">
                        <div>
                            <p className="text-sm font-medium text-slate-500">Gold Members</p>
                            <h3 className="text-2xl font-bold text-slate-900 mt-1">{stats.gold}</h3>
                        </div>
                ...
                <motion.div whileHover={{ y: -2 }} className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <h3 className="text-2xl font-bold text-slate-900 mt-1">{stats.totalPoints.toLocaleString()}</h3>
                        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="bg-gradient-to-br from-slate-400 to-slate-600 rounded-xl p-4 text-white shadow-md relative overflow-hidden">
                    ...
                    <div className="flex justify-between items-end">
                        <p className="text-sm text-slate-100">100+ points</p>
                ...
                <div className="p-4 border-b border-slate-200 flex flex-col sm:flex-row justify-between items-center gap-4 bg-slate-50">
                    <div className="relative w-full sm:w-72">
                        ...
                        <input
                            ...
                            className="w-full pl-9 pr-4 py-2 bg-white border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0B1B3D]/20 text-sm"
                        />
                    </div>
                </div>
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center justify-end gap-2">
                                                    <button 
                                                        ...
                                                        className="p-1.5 text-slate-500 hover:text-[#D4AF37] hover:bg-[#D4AF37]/10 rounded-md transition-colors tooltip-trigger relative"
                                                        title="Adjust Points"
                                                    >
                                                    ...
                                                    <button 
                                                        ...
                                                        className="p-1.5 text-slate-500 hover:text-[#0B1B3D] hover:bg-[#0B1B3D]/10 rounded-md transition-colors tooltip-trigger relative"
                ...
                {adjustPointsModal.isOpen && adjustPointsModal.member && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-slate-900/50 backdrop-blur-sm">
                        ...
                        >
                            ...
                            <div className="p-4 border-b border-slate-100 bg-amber-50 text-amber-800 text-sm flex gap-3">
                            ...
                            <form onSubmit={handleAdjustPoints} className="p-5 space-y-4">
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="block w-full pl-9 pr-3 py-2 border border-slate-300 rounded-lg focus:ring-[#0B1B3D] focus:border-[#0B1B3D] sm:text-sm"
                                        />
                                    </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="block w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-[#0B1B3D] focus:border-[#0B1B3D] sm:text-sm"
                                    />
                                </div>
                ...
                {tierOverrideModal.isOpen && tierOverrideModal.member && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-slate-900/50 backdrop-blur-sm">
                        ...
                        >
                            ...
                            <div className="p-4 border-b border-slate-100 bg-slate-50 text-slate-700 text-sm flex gap-3">
                                <Info className="w-5 h-5 shrink-0 text-slate-400" />
                                <div>
                                    <p className="font-medium text-slate-900">{tierOverrideModal.member.name}</p>
