              ...
              <div className="flex-1 flex flex-col justify-between">
                ...
                <div className="flex items-center justify-between mt-2">
                  <div className="flex items-baseline gap-1.5">
                    <span className="text-xs font-bold text-white font-mono">₹{flashPrice}</span>
                    <span className="text-[10px] text-slate-500 line-through font-mono">₹{product.price}</span>
                  </div>
